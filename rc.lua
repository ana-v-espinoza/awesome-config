...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create a tasklist widget to show the currently open windows
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "a", function () awful.spawn("pavucontrol -t 3") end,
    		{description = "open audio control", group = "pc control"}),

    -- Edit Configs
    awful.key({ modkey, "Shift" }, "b", function () awful.spawn(editor_cmd .. " /home/roberto/.bashrc") end,
    		{description = "bashrc", group = "edit configs"}),
    awful.key({ modkey }, "e", function () awful.spawn(editor_cmd .. " /home/roberto/.config/awesome/rc.lua") end,
